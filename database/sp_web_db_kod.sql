...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (1, 'BBQ Burger', 129, 5, 'bbq-burger.png', 'Je vyroben z hovězího masa a je ochucen BBQ omáčkou. Může být doplněn o další ingredience, jako je slanina, sýr, cibule a rajčata.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (2, 'Beef Burger', 139, 5, 'beef-burger.png', 'Obsahuje hovězí maso a může být doplněn o další ingredience, jako je sýr, cibule a rajčata.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (3, 'Grand Burger', 119, 5, 'grand-burger.png', 'Tento burger obsahuje hovězí maso, slaninu, sázené vejce, karamelizovanou cibuli, BBQ omáčku a tatarskou omáčku.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (4, 'Cheese Burger', 109, 5, 'cheese-burger.png', 'Uvnitř totoho burgeru se nachází hovězí maso a sýr. Může být doplněn o další ingredience, jako jsou cibule a rajčata.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (5, 'Chicken Burger', 145, 5, 'chicken-burger.png', 'Tento burger obsahuje kuřecí maso a může být doplněn o další ingredience, jako jsou sýr, cibule a rajčata.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (6, 'Vegetarian Burger', 105, 5, 'vegetarian-burger.png', 'Daný burger neobsahuje maso a může být vyroben z různých rostlinných ingrediencí, jako jsou fazole, quinoa nebo tofu.');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (7, 'Kola', 39, 5, 'kola.png', '0.5 l');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (8, 'Voda', 20, 5, 'voda.png', '0.5 l');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (9, 'Džus', 29, 5, 'dzus.png', '0.5 l');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (10, 'Hranolky', 45, 5, 'hranolky.jpg', '150 g');
INSERT INTO `produkt` (`id`, `nazev`, `cena`, `uskladneno_ks`, `foto`, `popis`) VALUES (11, 'Kečup', 29, 5, 'kecup.png', '20 ml');
COMMIT;